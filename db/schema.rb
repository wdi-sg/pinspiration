...
ActiveRecord::Schema.define(version: 2020_05_16_132213) do
  ...
  create_table "boardfollowees", force: :cascade do |t|
    ...
    t.bigint "user_id"
    t.bigint "board_id"
    t.index ["board_id"], name: "index_boardfollowees_on_board_id"
  ...
  create_table "pins_tags", force: :cascade do |t|
    t.bigint "pin_id"
    t.bigint "tag_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "boardfollowees", "boards"
