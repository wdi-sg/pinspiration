...
pins_list = [
  ["8 Amazing Coding Games for Beginners", "Learning to code has become a lot easier, nowadays there are many ways to learn coding, one of the best and most enjoyable ways are coding games, these will help you learn to code and understand basic computer programming.", "http://appexpanse.com/8-amazing-coding-games-for-beginners-to-improve-your-coding-skills/"],
  ["The Ultimate HTML 5 Cheat Sheet", "Designing websites can be quite a jungle sometimes since, with time, the number of languages at our disposal has gotten so much greater.", "https://bitrebels.com/design/the-ultimate-html-5-cheat-sheet/"],
