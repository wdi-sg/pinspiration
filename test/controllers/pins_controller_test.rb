...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post pins_url, params: { pin: { img: @pin.img, title: @pin.title, user_id_id: @pin.user_id_id } }
    end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { img: @pin.img, title: @pin.title, user_id_id: @pin.user_id_id } }
