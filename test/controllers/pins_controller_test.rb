...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post pins_url, params: { pin: { display: @pin.display, img_url: @pin.img_url, name: @pin.name } }
    end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { display: @pin.display, img_url: @pin.img_url, name: @pin.name } }
