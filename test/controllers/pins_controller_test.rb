...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post pins_url, params: { pin: { image_url: @pin.image_url, title: @pin.title, user_id: @pin.user_id } }
    end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { image_url: @pin.image_url, title: @pin.title, user_id: @pin.user_id } }
